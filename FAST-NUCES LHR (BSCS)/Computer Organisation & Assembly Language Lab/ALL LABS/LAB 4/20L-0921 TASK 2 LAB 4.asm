...
pop bp
	...
	ret 10 ;the ret instruction will pop the top most value from stack and put it in the ip, so the next instruction will be executed from the address popped from stack.
